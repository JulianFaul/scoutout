<template>
  <v-ons-col>
    ...
    <template>
      <router-link :to="'/product/'+ product.id" class="company-link">
      <li class="list-item list-item--chevron list-item--tappable">
        <div class="list__item__left">
          <img class="list__item__thumbnail" src="http://via.placeholder.com/300" alt="">
        </div>
        <div class="list-item__center">{{product.productName}}</div>
      </li>
      </router-link>
    </template>
...
export default {
  name: 'product-item',
  // the prop comes from productList
  props: ['product']
}
</script>
