...
<table style="width:100%; text-align:left;margin-top:20px;">
    ...
    <tr v-for="user in users" :key="user.id">
        ...
        <td style="text-align:right;">
            <ons-button @click="navigateTo({name:'edituser',params:{userId:user.id}})" modifier="small--cta " class="button button--material">Delete</ons-button>
            <ons-button @click="navigateTo({name:'deleteuser',params:{userId:user.id}})" modifier="small--cta " class="button button--material">Edit</ons-button>
        </td>
    ...
    <!-- <ul class="list">
        <li v-for="user in users" :key="user.id" class="list__item">
            <div class="list__item__left">
                    <img class="list__item__thumbnail" :src="user.imageURL" alt="">
                </div>

            <div class="list__item__center">
                <div class="list__item__title">{{user.firstName}} {{user.lastName}}</div>
                <div class="list__item__subtitle">{{user.email}}</div>
                
            </div>
            
            <div class="list__item__right">
                <ons-button @click="navigateTo({name:'edit',params:{user:advertisement.id}})" modifier="small--cta " class="button button--material">Edit</ons-button>
            </div>
        </li>
        {{users}}
    </ul> -->
